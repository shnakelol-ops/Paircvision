...
export default function SlateTextOverlay({
  annotations,
  active,
  onAnnotationsChange,
  ...
  return (
    ...
    >
      {/* Capture layer — intercepts taps on empty pitch when text tool active */}
      {active && (
        <div
          style={{
            position: "absolute",
          ...
          >
            {isEditing ? (
              ...
              >
                ...
                />
                {/* Inline toolbar: font size, colour, delete */}
                <div
                  style={{
                    display: "flex",
                    gap: "3px",
