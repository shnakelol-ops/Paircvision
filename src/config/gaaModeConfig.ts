...
> {
  return {
    ...
    // Event Stats (Pro Tagger)-only kinds — not surfaced by any Match Stats
    // event button; present here only because MatchEventKind is shared and
    // this map is exhaustive over it.
    FORTY_FIVE_WON: "45+",
